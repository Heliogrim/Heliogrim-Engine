...
set_property(GLOBAL PROPERTY global_stack_managed_options "")
...
# Option Management
macro(_push_stack_option name value)
	# TODO: Push previous value
	get_property(__stack_options GLOBAL PROPERTY global_stack_managed_options)
	list(APPEND __stack_options ${name})
	set_property(GLOBAL PROPERTY global_stack_managed_options "${__stack_options}")
endmacro()

function(_push_propagate_stack)
	set_property(GLOBAL PROPERTY global_stack_managed_options "")
endfunction()

function(_pop_propagate_stack)
	get_property(__stack_options GLOBAL PROPERTY global_stack_managed_options)
	set_property(GLOBAL PROPERTY global_stack_managed_options "")

	foreach (_stack_option ${__stack_options})
		unset(${_stack_option})
		unset(${_stack_option} CACHE)
...
function(propagate_option)
	...
	set(${args_VAR} ${__prop_val} CACHE INTERNAL "${args_NAME}" FORCE)
