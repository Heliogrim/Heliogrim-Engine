...
namespace hg::editor::gfx::loader {
	class EditorTiffTextureTransformer final :
		public EditorTextureSubTransformer {
	public:
		using this_type = EditorTiffTextureTransformer;

	public:
		EditorTiffTextureTransformer() noexcept;

		~EditorTiffTextureTransformer() noexcept override;
