...
namespace hg::editor::gfx::loader {
	class EditorPngTextureTransformer final :
		public EditorTextureSubTransformer {
	public:
		using this_type = EditorPngTextureTransformer;

	public:
		EditorPngTextureTransformer() noexcept;

		~EditorPngTextureTransformer() noexcept override;
