...
namespace hg::engine::gfx::glow::render {
    ...
    public:
        using this_type = RevEarlyEnvIrradiance;

    public:
        RevEarlyEnvIrradiance();

        ~RevEarlyEnvIrradiance() override = default;
    ...
    private:
        math::uivec2 _envIrradExtent;
        TextureFormat _envIrradFormat;
