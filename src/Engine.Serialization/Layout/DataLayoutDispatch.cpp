...
void DataLayoutDispatch::load(ref<resource::Archive> archive_, std::span<u8, ::std::dynamic_extent> dst_) const {
...
void DataLayoutDispatch::store(ref<resource::Archive> archive_, std::span<u8, ::std::dynamic_extent> src_) const {
