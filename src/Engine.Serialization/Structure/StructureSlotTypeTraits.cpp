...
string_view StructureSlotTypeTrait::canonical(const StructureSlotType type_) noexcept {
	switch (type_) {
...
s64 StructureSlotTypeTrait::const_size(const StructureSlotType type_) noexcept {
	switch (type_) {
