...
static void setup_graph_expectation(cref<uptr<graph::CompileGraph>> graph_, mref<smr<const graph::Symbol>> ocs_) {
...
static auto make_accel_vertex_l0_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_vertex_l1_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_vertex_l2_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_fragment_l0_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_fragment_l1_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_fragment_l2_stage() -> uptr<engine::accel::Stage> {
...
static auto make_accel_l0_effect() -> uptr<engine::accel::AccelerationEffect> {
...
static auto make_accel_l1_effect() -> uptr<engine::accel::AccelerationEffect> {
...
static auto make_accel_l2_effect() -> uptr<engine::accel::AccelerationEffect> {
...
static auto make_material_prototype() -> uptr<material::MaterialPrototype> {
...
static auto make_material() -> smr<MaterialResource> {
