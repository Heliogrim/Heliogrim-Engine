...
using Engine = ::ember::engine::Engine;

#if USE_MAIN_THREAD_INJECTION

extern void beforeRoutine();

extern void onEngineCreate(const ember::non_owning_rptr<Engine> engine_);

extern void onEnginePreInit(const ember::non_owning_rptr<Engine> engine_);

extern void onEngineInit(const ember::non_owning_rptr<Engine> engine_);

extern void onEnginePostInit(const ember::non_owning_rptr<Engine> engine_);

extern void onEngineStart(const ember::non_owning_rptr<Engine> engine_);
 ...
 */
extern void onEngineRunning(const ember::non_owning_rptr<Engine> engine_);
...
extern void onEngineStop(const ember::non_owning_rptr<Engine> engine_);

extern void onEngineShutdown(const ember::non_owning_rptr<Engine> engine_);

extern void onEngineExit(const ember::non_owning_rptr<Engine> engine_);
