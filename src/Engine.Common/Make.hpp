...
namespace hg {
    ...
    template <CompleteType Ty_, class... Args_> requires _STD is_constructible_v<Ty_, Args_...>
    ...
    template <CompleteType Ty, class... Args> requires _STD is_constructible_v<Ty, Args...>
