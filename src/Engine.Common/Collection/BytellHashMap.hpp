...
namespace ska {
    ...
    namespace detailv8 {
        ...
        struct sherwood_v8_constants {
            static constexpr int8_t magic_for_empty = 0b11111111i8;
            static constexpr int8_t magic_for_reserved = 0b11111110i8;
            static constexpr int8_t bits_for_direct_hit = 0b10000000i8;
            static constexpr int8_t magic_for_direct_hit = 0b00000000i8;
            static constexpr int8_t magic_for_list_entry = 0b10000000i8;

            static constexpr int8_t bits_for_distance = 0b01111111i8;
