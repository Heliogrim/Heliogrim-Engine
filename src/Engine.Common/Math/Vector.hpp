...
namespace hg::math {
	...
	public:
		...
		constexpr reference_type normalize() {
			static_assert(std::numeric_limits<value_type>::is_iec559, "'normalize' accepts only floating point");
		...
		constexpr type normalized() const {
			static_assert(std::numeric_limits<value_type>::is_iec559, "'normalized' accepts only floating point");
		...
		constexpr reference_type cross(const_reference_type other_) {
			static_assert(std::numeric_limits<value_type>::is_iec559, "'cross' accepts only floating point");
		...
		constexpr type crossed(const_reference_type other_) const {
			static_assert(std::numeric_limits<value_type>::is_iec559, "'crossed' accepts only floating point");
