...
smr<AccelerationEffect> build_test_effect() {
	...
	const auto vertexShaderCode = read_shader_file(R"(postprocessing/__test__pp.vs)");
	const auto fragmentShaderCode = read_shader_file(R"(postprocessing/__test__pp.fs)");
