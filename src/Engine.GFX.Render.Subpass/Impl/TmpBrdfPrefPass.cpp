...
smr<AccelerationEffect> build_test_effect() {
	...
	const auto vertexShaderCode = read_shader_file(R"(brdf/__test__brdfPref.gen.vs)");
	...
	const auto fragmentShaderCode = read_shader_file(R"(brdf/__test__brdfPref.gen.fs)");
