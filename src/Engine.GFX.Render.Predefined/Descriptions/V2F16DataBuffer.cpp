...
smr<const graph::Description> engine::gfx::render::makeV2F16DataBufferDescription() {
    static auto obj = make_smr<graph::TextureDescription>(
        ...
        graph::DescriptionValue { graph::DescriptionValueMatchingMode::eInvariant, TextureFormat::eR16G16Sfloat },
