...
namespace hg {
    ...
    public:
        ...
        public:
            ...
            constexpr Iterator(const pointer cursor_) noexcept :
                _cursor(cursor_) {}
        ...
        public:
            ...
            constexpr ConstIterator(const const_pointer cursor_) noexcept :
                _cursor(cursor_) {}
    ...
    public:
        ...
        [[nodiscard]] constexpr ConstIterator end() const noexcept {
            return ConstIterator { _data + Size_ };
        }

        [[nodiscard]] constexpr Iterator end() noexcept {
            return Iterator { _data + Size_ };
        }
    };
