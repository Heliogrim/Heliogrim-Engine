...
static void initMaterialDefaults() {
    ...
    db->insert(factory->createImageAsset(image::DefaultAlpha::unstable_auto_guid(),
        R"(resources\imports\ktx\default_alpha.ktx)"));
    db->insert(factory->createImageAsset(image::DefaultAO::unstable_auto_guid(),
        R"(resources\imports\ktx\default_ao.ktx)"));
    db->insert(factory->createImageAsset(image::DefaultDiffuse::unstable_auto_guid(),
        R"(resources\imports\ktx\default_diffuse.ktx)"));
    db->insert(factory->createImageAsset(image::DefaultMetalness::unstable_auto_guid(),
        R"(resources\imports\ktx\default_metalness.ktx)"));
    db->insert(factory->createImageAsset(image::DefaultNormal::unstable_auto_guid(),
        R"(resources\imports\ktx\default_normal.ktx)"));
    db->insert(factory->createImageAsset(image::DefaultRoughness::unstable_auto_guid(),
...
static void initSkyboxDefaults() {
    ...
    db->insert(factory->createImageAsset(image::DefaultSkybox::unstable_auto_guid(),
...
static void initDirectoryIcons() {
    ...
    db->insert(factory->createImageAsset(image::Directory::unstable_auto_guid(),
        R"(resources\imports\ktx\icons8-folder-144.ktx)"));

    db->insert(factory->createImageAsset(image::FolderAnimation::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-animation.ktx)"));
    db->insert(factory->createImageAsset(image::FolderAudio::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-audio.ktx)"));
    db->insert(factory->createImageAsset(image::FolderConfig::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-config.ktx)"));
    db->insert(factory->createImageAsset(image::FolderContent::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-content.ktx)"));
    db->insert(factory->createImageAsset(image::FolderCore::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-core.ktx)"));
    db->insert(factory->createImageAsset(image::FolderDatabase::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-database.ktx)"));
    db->insert(factory->createImageAsset(image::FolderDebug::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-debug.ktx)"));
    db->insert(factory->createImageAsset(image::FolderEnvironment::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-environment.ktx)"));
    db->insert(factory->createImageAsset(image::FolderError::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-error.ktx)"));
    db->insert(factory->createImageAsset(image::FolderFont::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-font.ktx)"));
    db->insert(factory->createImageAsset(image::FolderGenerator::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-generator.ktx)"));
    db->insert(factory->createImageAsset(image::FolderImages::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-images.ktx)"));
    db->insert(factory->createImageAsset(image::FolderImport::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-import.ktx)"));
    db->insert(factory->createImageAsset(image::FolderLib::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-lib.ktx)"));
    db->insert(factory->createImageAsset(image::FolderLog::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-log.ktx)"));
    db->insert(factory->createImageAsset(image::FolderMeta::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-meta.ktx)"));
    db->insert(factory->createImageAsset(image::FolderPackages::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-packages.ktx)"));
    db->insert(factory->createImageAsset(image::FolderResource::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-resource.ktx)"));
    db->insert(factory->createImageAsset(image::FolderScripts::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-scripts.ktx)"));
    db->insert(factory->createImageAsset(image::FolderShader::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-shader.ktx)"));
    db->insert(factory->createImageAsset(image::FolderShared::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-shared.ktx)"));
    db->insert(factory->createImageAsset(image::FolderTemplate::unstable_auto_guid(),
        R"(resources\imports\ktx\folder-template.ktx)"));
    db->insert(factory->createImageAsset(image::FolderVideo::unstable_auto_guid(),
...
static void initFileIcons() {
    ...
    db->insert(factory->createImageAsset(image::Brand::unstable_auto_guid(),
        R"(resources\imports\ktx\brand.ktx)"));

    db->insert(factory->createImageAsset(image::Icon3d::unstable_auto_guid(),
        R"(resources\imports\ktx\3d.ktx)"));
    db->insert(factory->createImageAsset(image::IconArchitecture::unstable_auto_guid(),
        R"(resources\imports\ktx\architecture.ktx)"));
    db->insert(factory->createImageAsset(image::IconAudio::unstable_auto_guid(),
        R"(resources\imports\ktx\audio.ktx)"));
    db->insert(factory->createImageAsset(image::IconC::unstable_auto_guid(),
        R"(resources\imports\ktx\c.ktx)"));
    db->insert(factory->createImageAsset(image::IconCMake::unstable_auto_guid(),
        R"(resources\imports\ktx\cmake.ktx)"));
    db->insert(factory->createImageAsset(image::IconCommand::unstable_auto_guid(),
        R"(resources\imports\ktx\command.ktx)"));
    db->insert(factory->createImageAsset(image::IconConsole::unstable_auto_guid(),
        R"(resources\imports\ktx\console.ktx)"));
    db->insert(factory->createImageAsset(image::IconContributing::unstable_auto_guid(),
        R"(resources\imports\ktx\contributing.ktx)"));
    db->insert(factory->createImageAsset(image::IconCpp::unstable_auto_guid(),
        R"(resources\imports\ktx\cpp.ktx)"));
    db->insert(factory->createImageAsset(image::IconCSharp::unstable_auto_guid(),
        R"(resources\imports\ktx\csharp.ktx)"));
    db->insert(factory->createImageAsset(image::IconDatabase::unstable_auto_guid(),
        R"(resources\imports\ktx\database.ktx)"));
    db->insert(factory->createImageAsset(image::IconDiff::unstable_auto_guid(),
        R"(resources\imports\ktx\diff.ktx)"));
    db->insert(factory->createImageAsset(image::IconDocument::unstable_auto_guid(),
        R"(resources\imports\ktx\document.ktx)"));
    db->insert(factory->createImageAsset(image::IconFavicon::unstable_auto_guid(),
        R"(resources\imports\ktx\favicon.ktx)"));
    db->insert(factory->createImageAsset(image::IconFont::unstable_auto_guid(),
        R"(resources\imports\ktx\font.ktx)"));
    db->insert(factory->createImageAsset(image::IconGit::unstable_auto_guid(),
        R"(resources\imports\ktx\git.ktx)"));
    db->insert(factory->createImageAsset(image::IconH::unstable_auto_guid(),
        R"(resources\imports\ktx\h.ktx)"));
    db->insert(factory->createImageAsset(image::IconHpp::unstable_auto_guid(),
        R"(resources\imports\ktx\hpp.ktx)"));
    db->insert(factory->createImageAsset(image::IconI18n::unstable_auto_guid(),
        R"(resources\imports\ktx\i18n.ktx)"));
    db->insert(factory->createImageAsset(image::IconImage::unstable_auto_guid(),
        R"(resources\imports\ktx\image.ktx)"));
    db->insert(factory->createImageAsset(image::IconJson::unstable_auto_guid(),
        R"(resources\imports\ktx\json.ktx)"));
    db->insert(factory->createImageAsset(image::IconLib::unstable_auto_guid(),
        R"(resources\imports\ktx\lib.ktx)"));
    db->insert(factory->createImageAsset(image::IconLog::unstable_auto_guid(),
        R"(resources\imports\ktx\log.ktx)"));
    db->insert(factory->createImageAsset(image::IconLua::unstable_auto_guid(),
        R"(resources\imports\ktx\lua.ktx)"));
    db->insert(factory->createImageAsset(image::IconPdf::unstable_auto_guid(),
        R"(resources\imports\ktx\pdf.ktx)"));
    db->insert(factory->createImageAsset(image::IconPipeline::unstable_auto_guid(),
        R"(resources\imports\ktx\pipeline.ktx)"));
    db->insert(factory->createImageAsset(image::IconReadme::unstable_auto_guid(),
        R"(resources\imports\ktx\readme.ktx)"));
    db->insert(factory->createImageAsset(image::IconSearch::unstable_auto_guid(),
        R"(resources\imports\ktx\search.ktx)"));
    db->insert(factory->createImageAsset(image::IconSettings::unstable_auto_guid(),
        R"(resources\imports\ktx\settings.ktx)"));
    db->insert(factory->createImageAsset(image::IconShader::unstable_auto_guid(),
        R"(resources\imports\ktx\shader.ktx)"));
    db->insert(factory->createImageAsset(image::IconTemplate::unstable_auto_guid(),
        R"(resources\imports\ktx\template.ktx)"));
    db->insert(factory->createImageAsset(image::IconTodo::unstable_auto_guid(),
        R"(resources\imports\ktx\todo.ktx)"));
    db->insert(factory->createImageAsset(image::IconTree::unstable_auto_guid(),
        R"(resources\imports\ktx\tree.ktx)"));
    db->insert(factory->createImageAsset(image::IconUrl::unstable_auto_guid(),
        R"(resources\imports\ktx\url.ktx)"));
    db->insert(factory->createImageAsset(image::IconVideo::unstable_auto_guid(),
        R"(resources\imports\ktx\video.ktx)"));
    db->insert(factory->createImageAsset(image::IconZip::unstable_auto_guid(),
...
static void initFontDefaults() {
    ...
    db->insert(factory->createFontAsset(font::CascadiaCode::unstable_auto_guid(),
