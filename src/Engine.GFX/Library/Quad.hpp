	...
	public:
		...
		Quad(const __Device& device_) {
			const std::vector<Vertex> vertices = std::vector<Vertex> {
				Vertex(__internal::types::vec3(1.F, 1.F, 0.F), __internal::types::vec3(1.F),
					__internal::types::vec2(1.F, 1.F), __internal::types::vec3(0.F)),
				Vertex(__internal::types::vec3(0.F, 1.F, 0.F), __internal::types::vec3(1.F),
					__internal::types::vec2(0.F, 1.F), __internal::types::vec3(0.F)),
				Vertex(__internal::types::vec3(0.F, 0.F, 0.F), __internal::types::vec3(1.F),
					__internal::types::vec2(0.F, 0.F), __internal::types::vec3(0.F)),
				Vertex(__internal::types::vec3(1.F, 0.F, 0.F), __internal::types::vec3(1.F),
					__internal::types::vec2(1.F, 0.F), __internal::types::vec3(0.F))
			};
