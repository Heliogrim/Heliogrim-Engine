...
namespace clockwork::__internal::gfx::types
{
	...
	protected:
		ObjStagedBuffer(const clockwork::__internal::gfx::types::__Device& device_, const Buffer& stage_, const Buffer& dest_, const size_t instanceCount_) :
	...
	public:
		 ...
		 */
		static ObjStagedBuffer<Ty> make(const clockwork::__internal::gfx::types::__Device& device_, const BufferUsageFlags& usage_, const size_t instanceCount_ = 1)
		{
			if (instanceCount_ < 1)
