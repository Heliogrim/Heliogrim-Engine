#pragma once
#include "../Inc.hpp"
#include "../Library/Mapping/TextureMapping.hpp"

namespace clockwork::__internal::gfx {
    class Graphics;
}

namespace clockwork::__internal::gfx::texture {
    class Texture;
}
...
namespace clockwork::__internal::gfx::handle {
    ...
    public:
        ...
        using value_type = texture::Texture;
    ...
    private:
        mapping::__ptr__TextureMapping _mapping;
    ...
    TYPE_UNIQUE(TextureHandler, TextureHandler);
}
