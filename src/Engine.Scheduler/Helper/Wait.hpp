...
namespace ember::engine::scheduler {
     ...
     */
    void waitOnAtomic(ref<_STD atomic_flag> atomic_, const bool prev_);
     ...
     * @param prev_ The value which should change.
     */
    void waitOnAtomic(ref<_STD atomic_uint_fast8_t> atomic_, const u8 prev_);
     ...
     */
    void waitUntilAtomic(ref<_STD atomic_flag> atomic_, const bool expect_);
     ...
     * @param expect_ The value to wait for.
     */
    void waitUntilAtomic(ref<_STD atomic_uint_fast8_t> atomic_, const u8 expect_);
}
