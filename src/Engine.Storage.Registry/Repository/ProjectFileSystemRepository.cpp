...
bool ProjectFileSystemRepository::hasStorage(cref<StorageUrl> url_) const {
...
Arci<engine::storage::IStorage> ProjectFileSystemRepository::getStorageByUrl(cref<StorageUrl> url_) const {
	if (not url_.is<FileUrl>())
		return {};
