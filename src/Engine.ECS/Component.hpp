...
namespace ember::engine::ecs {
    ...
    /**
     * The is component
     *	Component should be like a pdo, no virtual functions, no complex move and construct.
     *	Component should be in-place constructable and memcpy-able
     */
