...
namespace hg::editor {
	class GenerateProjectStructureSubAction final :
		public InheritMeta<GenerateProjectStructureSubAction, SubAction> {
	public:
		using this_type = GenerateProjectStructureSubAction;

	public:
		explicit GenerateProjectStructureSubAction(_In_ cref<Action> parentAction_);

		~GenerateProjectStructureSubAction() override = default;
